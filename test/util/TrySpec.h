...
private slots:
    void constructor_and_apply_should_properly_instantiate_Try() {
        ...
        Try<int> t2(new haruneko::util::Exception()); QVERIFY_EXCEPTION_THROWN(t2.get(), Exception*); QCOMPARE(t2.isFailure(), true);
        ...
        Try<int> t5(applyTry<int>([]() -> int { throw new haruneko::util::Exception; }));
